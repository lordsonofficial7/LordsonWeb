...
//       bg-gradient-to-l from-white via-gray-800 to-black text-white overflow-hidden z-0"
//     >
//       <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 py-12 md:py-20 gap-10 h-full">
//         {/* Left: Text Section */}
...
//           <div className="relative w-72 h-72 md:w-[750px] md:h-[750px] rounded-xl overflow-hidden shadow-2xl border-4 border-gray-700 ">
//             <img
//               src={banner.image}
//               alt={banner.title}
...
//     <div
//             className="relative w-64 h-64 md:w-[750px] md:h-[750px] 
//                        rounded-xl overflow-hidden shadow-2xl border-4 border-gray-700 
//                        transform md:translate-x-10 lg:translate-x-25"  
//             // 👆 Moves image right visually without reducing its width
//           >            <img
//               src={banner.image}
//               alt={banner.title}
//               className="absolute inset-0 w-full h-full object-cover"
